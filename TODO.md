...
- DONE: enhance System stats in settings report — add Pi version, OS details (macOS/linux kernel version), CPU arch details, shell, terminal type, locale. See `settings-reporter.ts:getSystemInfo()`.

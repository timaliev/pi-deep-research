...
function narrativeQuestioning(plan: ResearchPlan, currentDepth: number, totalDepth: number): string {
...
function subtopicsQuestioning(plan: ResearchPlan, currentDepth: number, totalDepth: number): string {
...
export interface ReportStyle {
  buildExtractionPrompt: typeof narrativeExtraction;
  buildQuestioningPrompt: typeof narrativeQuestioning;
...
export function createReportStyle(name: string): ReportStyle | undefined {
  ...
  if (name === "subtopics") {
    return {
      ...
      buildQuestioningPrompt: subtopicsQuestioning,
